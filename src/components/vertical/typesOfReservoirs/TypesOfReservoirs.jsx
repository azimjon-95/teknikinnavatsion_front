...
export default function TypesOfReservoirs({ lang = "ru" }) {
  ...
  const translations = {
    ru: {
      ...
      construction: {
        ...
        conical: {
          title: "Коническая оболочка (коническая бескаркасная крыша)",
          description:
        ...
        spherical: {
          title: "Сферическая оболочка (бескаркасная сферическая крыша).",
          description:
        ...
        conicalFrame: {
          title: "Каркасная коническая кровля резервуара",
          description:
        ...
        sphericalFrame: {
          title: "Сферическая каркасная (купольная крыша)",
          description:
      ...
      ladders: {
        title: "Лестницы для резервуаров, площадки и переходы",
        laddersTitle: "Лестницы",
        description:
        ...
        ring: "Кольцевая лестница закрепляется только на стенке резервуара, ее нижний марш отстает от земли на 250 мм. Такая конструкция лестницы более удобна для обслуживания технологического оборудования.",
        specifications:
    ...
    uz: {
      ...
      construction: {
        ...
        conical: {
          title: "Konussimon qobiq (konussimon karkassiz tom)",
          description:
            "Vertikal po‘lat rezervuarlarda kichik hajmli (100 m³ – 1000 m³) qo‘llaniladi. Konus shaklida yasalgan statsionar tom hisoblanadi. Konus burchagi (15° – 30°) tomning yuk ko‘tarish qobiliyatini ta’minlaydi. Yuk ko‘tarish qobiliyatini oshirish uchun tom tashqi tomonidan shpangoutlar (halqa shaklidagi qattiqlashtiruvchi qovurg‘alar) bilan jihozlanadi. Bunday tomning qoplamasi zavodda rulonlash yoki listlab tayyorlanadi. Birinchi holda metalloprokat qalinligi 7 mm gacha, ikkinchi holda 10 mm gacha ishlatiladi. Odatda, konussimon karkassiz tom montaj maydoniga sektorli kesimga ega dumaloq shakldagi plastina ko‘rinishida yetkaziladi. Ushbu kesim montaj jarayonida qirralari tortilganda tomning konussimon shaklini hosil qiladi.",
        },
        spherical: {
          title: "Sferik qobiq (karkassiz sferik tom)",
          description:
            "Vertikal po‘lat silindrsimon rezervuarlarda o‘rtacha hajmli (1000 m³ – 5000 m³) qo‘llaniladi. Sfera shaklidagi statsionar tom bo‘lib, uning yuk ko‘tarish qobiliyatini ta’minlaydi. Karkasning yuk ko‘taruvchi elementlari mavjud emas. Sfera radiusi rezervuar diametri 0,8 – 1,2 oralig‘ida loyihalanadi. Sferik qobiqning qoplamasi zavod sharoitida ikki tomonlama egrilikka ega (meridional va halqa yo‘nalishida) valtslangan elementlardan tayyorlanadi, metalloprokat qalinligi 10 mm gacha bo‘ladi. Montaj maydonida valtslangan elementlar ikki tomonlama choklar bilan payvandlanadi.",
        },
        conicalFrame: {
          title: "Karkasli konussimon tom",
          description:
            "O‘rtacha hajmli vertikal silindrsimon rezervuarlarda (1000 m³ – 5000 m³) qo‘llaniladi. Tom konus shaklidagi statsionar konstruksiya hisoblanadi. Nishab burchagi: 4,76º – 9,46º. Quyidagilardan iborat: (1) markaziy qalqon; (2) sektorli karkaslar; (3) halqa elementlari; (4) qoplama listlari.",
          additional:
            "Yuqorida sanab o‘tilgan barcha elementlar zavod sharoitida ishlab chiqariladi. Qoplama listlari rulonlash usulida tayyorlanishi mumkin. Bu holda montajda ular rezervuar yonida yerga yozilib, tayyor karkaslarga mahkamlanadi. Qoplama listlari listlab ham tayyorlanishi mumkin. Ko‘pincha zavod sharoitida karkas va qoplamadan yig‘ilgan tom qalqonlari ishlab chiqariladi. Bunday qalqonlar maxsus qadoqda montaj maydoniga yetkaziladi.",
          explosion:
            "Konussimon karkasli tom portlashdan himoyalangan ko‘rinishda ham tayyorlanishi mumkin (oson ajraladigan tom). Bunday holda tom qoplamasi karkasga payvandlanmaydi, faqat devorning yuqori halqa elementiga mahkamlanadi. Natijada rezervuar ichida bosim oshganda qoplama devordan ajraladi, ammo rezervuarning o‘zi buzilmaydi va devor bilan tub orasidagi mahkamlash saqlanib qoladi.",
        },
        sphericalFrame: {
          title: "Sferik karkasli (gumbazsimon tom)",
          description:
            "Katta hajmli vertikal po‘lat rezervuarlarda (5000 m³ dan boshlab, lekin diametri 50 m dan oshmagan) qo‘llaniladi. Sfera shaklidagi statsionar tom bo‘lib, radial-halqa karkas tizimiga ega. Sfera radiusi rezervuar diametri 0,8 – 1,5 oralig‘ida loyihalanadi. Sferik karkasli tom quyidagilardan iborat: (1) markaziy qalqon; (2) valtslangan radial balkalar; (3) halqa elementlari; (4) devor perimetri bo‘ylab qattiqlashtiruvchi halqa; (5) qoplama listlari.",
          additional:
            "Barcha elementlar zavodda ishlab chiqariladi. Montaj maydoniga tayyor qalqonlar hamda karkas va qoplama elementlari alohida holda yetkaziladi. Qoplama listlari polistavka uchun tayyorlangan metall listlardan yoki zavodda yasalgan yirik kartalardan iborat bo‘ladi.",
          explosion:
            "Sferik tomlar ham portlashdan himoyalangan ko‘rinishda ishlab chiqariladi. Bu holda qoplama faqat tomning tashqi perimetri bo‘ylab halqa elementiga mahkamlanadi. Shu orqali rezervuar ichida bosim oshganda qoplama devordan ajraladi, ammo rezervuarning o‘zi buzilmaydi va devor bilan tub orasidagi mahkamlash saqlanib qoladi.",
        },
        floating: {
          title: "Suzuvchi tomlar",
          description:
            "Statsionar tomi bo‘lmagan po‘lat rezervuarlarda qo‘llaniladi. Bunday tomlar me’yoriy qor yuklamasi 1,5 kPa gacha bo‘lgan hududlarda ishlatilishi mumkin.",
          types:
            "Rezervuar qurilishida 2 asosiy turdagi suzuvchi tomlar qo‘llaniladi: (1) bir qavatli suzuvchi tom; (2) ikki qavatli suzuvchi tom.",
          single:
            "Bir qavatli suzuvchi tomlar o‘rtacha o‘lchamdagi rezervuarlarda (diametri 50 m gacha) ishlatiladi. Ular shamol tezligi 100 km/soatgacha bo‘lgan hududlarda qo‘llaniladi.",
          singleComponents:
            "Bir qavatli suzuvchi tomlar zavodda tayyorlanadi va quyidagilardan iborat:",
          singleList: [
            "rulonlash yoki listlab tayyorlangan qoplama membranasi;",
            "rezervuar perimetri bo‘ylab joylashgan halqa qutilari.",
          ],
          double:
            "Ikki qavatli suzuvchi tomlar katta diametrli rezervuarlar (50 m dan ortiq) va kuchli shamolli hududlar uchun ishlab chiqilgan. Bunday konstruktsiya membranaga tushadigan dinamik yuklarni kamaytiradi. Ikki xil yechim mavjud: (1) tom montaj jarayonida markaziy radial va halqa qutilaridan yig‘iladi; (2) radial qutilar zavodda tayyorlanib, montaj hajmini kamaytiradi.",
          installation:
            "Montaj vaqtida suzuvchi tomning markazga qarab nishabi yuk yordamida ta’minlanadi. Bu yomg‘ir suvini tom yuzasidan oqizib yuboradi. Markazda suvni chiqarish uchun qaytma klapanli moslama o‘rnatiladi. Bu suvni chiqarishga yordam beradi va shu bilan birga rezervuar ichidagi mahsulotning tom yuzasiga chiqishini oldini oladi.",
          sealing:
            "Suzuvchi tom bilan devor orasida va quvurlar bilan yo‘riqnoma orasida hosil bo‘ladigan bo‘shliqlarni germetiklash uchun zichlovchi moslamalar qo‘llaniladi. Ular ishlab chiqariladigan material rezervuarda saqlanadigan mahsulotning kimyoviy tarkibi va haroratidan kelib chiqib tanlanadi. Bundan tashqari, xizmat muddati, gaz o‘tkazmasligi va boshqa maxsus talablar ham hisobga olinadi.",
        },
      },
      ladders: {
        title:
          "Rezervuarlar uchun zinapoyalar, maydonchalar va o‘tish yo‘laklari",
        laddersTitle: "Zinapoyalar",
        description:
          "Vertikal silindrsimon rezervuarlarga chiqish uchun 3 turdagi zinapoyalar qo‘llaniladi: kichik hajmli RVS (500 m³ gacha) uchun oddiy narvon, shaxtasimon zinapoya va halqa (aylana) zinapoya.",
        shaft:
          "Rezervuar shaxtasimon zinapoyasi alohida poydevorga o‘rnatiladi. Metallokonstruktsiyalarni rulonlash usulida ishlab chiqarishda shaxtasimon zinapoya texnologik karkas (katушка) vazifasini bajaradi – unga devor, tub va tom qoplamasi qotirilgan listlar o‘raladi. Bu mahsulotni buyurtma qilishda tejamkorlikni ta’minlaydi, chunki texnologik karkas (qaytarilmaydigan qadoq)ni tayyorlash zarurati yo‘qoladi.",
        ring: "Halqa (aylana) zinapoya faqat rezervuar devoriga mahkamlanadi, uning pastki qismi yer yuzasidan 250 mm balandlikda joylashadi. Bunday konstruktsiya texnologik jihozlarni xizmat ko‘rsatishda qulaylik yaratadi.",
        specifications:
          "Vertikal po‘lat rezervuarlar uchun zinapoyalar minimal eni 700 mm qilib loyihalanadi. Zinapoya gorizontal sathga nisbatan 50° dan ortiq burchak ostida o‘rnatilmaydi va 4,5 kN yukni ko‘tara olishi kerak. Agar zinapoya balandligi 9 m dan oshsa, loyiha har 6 m da oraliq maydonchalarni ko‘zda tutishi lozim.",
        steps:
          "Zinapoya qadamlari perforatsiyalangan, panjara yoki relyefli metallardan yasaladi, minimal eni 200 mm, balandligi 250 mm gacha, orqa qirraga 2°–5° qiyalikda bo‘lishi kerak. Poya qo‘llari 0,9 kN gorizontal yukni ko‘tara oladigan qilib tayyorlanadi va 1 m balandlikda o‘rnatiladi.",
        platformsTitle: "Maydonchalar, o‘tish yo‘laklari va panjaralar",
        platforms:
          "Statsionar tomli vertikal silindrsimon rezervuarlarda tom perimetri bo‘ylab panjara o‘rnatiladi. Shuningdek, xizmat ko‘rsatish maydonchalari tashqi tomoniga ham panjaralar o‘rnatiladi. Panjara har qanday nuqtada 0,9 kN yukni har qanday yo‘nalishda ko‘tara olishi lozim.",
        platformsAdditional:
          "Shuningdek, o‘tish yo‘laklari va xizmat maydonchalari qo‘llaniladi. Ular 1,25 m balandlikdagi qo‘llanmalarga ega bo‘ladi. Maydonchalar va yo‘laklar 4,5 kN yukni ko‘tara oladi (100 mm x 100 mm joyga tushgan yuk).",
      },
    },
    en: {
      ...
      construction: {
        ...
        conical: {
          title: "Conical shell (conical frameless roof)",
          description:
            "Used on vertical steel reservoirs of small volume (100 m³ – 1000 m³). It is a stationary roof in the form of a cone. The cone angle (15° – 30°) ensures the bearing capacity of the reservoir roof. To increase the bearing capacity, the roof is equipped with frames (ring-shaped stiffening ribs) on the outer side. The deck of such a roof is manufactured at the factory by rolling or sheet method. In the first case, metal products with a thickness of up to 7 mm are used, in the second - up to 10 mm. As a rule, a conical frameless roof is delivered to the installation site in the form of a round plate with a sector cutout. This cutout ensures the conical shape of the roof when its edges are tightened during installation.",
        },
        spherical: {
          title: "Spherical shell (frameless spherical roof).",
          description:
            "Used on vertical steel cylindrical reservoirs of medium volume (1000 m³ – 5000 m³). It is a stationary roof in the form of a sphere, which ensures its bearing capacity. Bearing frame elements are absent. The sphere radius is designed within 0.8 – 1.2 of the reservoir diameter itself. The spherical shell deck is made in factory conditions in the form of rolled elements of double curvature (in meridional and annular direction) from metal products with a thickness of up to 10 mm. At the installation site, rolled elements are welded to each other with double-sided seams.",
        },
        conicalFrame: {
          title: "Frame conical roof of reservoir",
          description:
            "Used on vertical cylindrical reservoirs of medium volume (1000 m³ – 5000 m³). The reservoir roof is a stationary roof in the form of a cone. Tilt angle: 4.76º – 9.46º. Consist of: (1) central shield; (2) sector frames; (3) annular frame elements; (4) deck sheets.",
          additional:
            "All the above elements are manufactured in factory conditions. Deck sheets can be manufactured, in particular, by rolling method. In this case, during installation they are unfolded on the ground next to the bottom and then attached to already connected frames. Deck sheets can also be manufactured by sheet method. The practice of manufacturing roof shields in factory conditions, consisting of interconnected frame and deck elements, is also often used. In this case, roof shields are delivered to the installation site in special packaging.",
          explosion:
            "Conical frame roof can be manufactured in explosion-proof design (easily removable roof). In this case, the roof deck is not welded to the frame, but is attached only to the upper annular element of the wall. This achieves that when the pressure inside the reservoir is exceeded, the deck breaks away from the wall. At the same time, the reservoir itself is not destroyed and the integrity of the wall attachment to the bottom is preserved.",
        },
        sphericalFrame: {
          title: "Spherical frame (dome roof)",
          description:
            "Used on vertical steel reservoirs of large volume (from 5000 m³, but not more than 50 m in diameter). They are stationary roofs in the form of a sphere with a radial-ring frame system. The sphere radius is designed within 0.8 – 1.5 diameters of the reservoir itself. The spherical frame roof of the reservoir consists of: (1) central shield; (2) rolled radial beams; (3) annular frame elements; (4) stiffness ring along the wall perimeter; (5) deck sheets.",
          additional:
            "All the above elements are manufactured in factory conditions. They are delivered to the installation site in the form of ready-made shields and separate frame and deck elements. The deck represents prepared metal sheets for sheet assembly, or large-sized cards prepared at the factory",
          explosion:
            "Spherical roofs are also manufactured in explosion-proof design. In this case, the deck is attached only to the framing element around the roof circumference. This achieves that when the pressure inside the reservoir is exceeded, the deck breaks away from the wall. At the same time, the reservoir itself is not destroyed and the integrity of the wall attachment to the bottom is preserved.",
        },
        floating: {
          title: "Floating roofs.",
          description:
            "Used in steel reservoirs not equipped with stationary roof. This type of roof can be used in areas with standard snow load up to 1.5 kPa.",
          types:
            "In reservoir construction practice, 2 main types of floating roofs are used: (1) single-deck floating roof and (2) double-deck floating roof.",
          single:
            "Single-deck floating roofs are equipped with medium-sized reservoirs (up to 50 m in diameter), installed at production sites with standard wind speed within 100 km/h.",
          singleComponents:
            "Single-deck floating roofs are manufactured in factory conditions and consist of:",
          singleList: [
            "sheet membrane made by rolling or sheet method;",
            "annular boxes located around the perimeter.",
          ],
          double:
            "Double-deck floating roofs are designed for vertical reservoirs of larger diameter (more than 50 m) and for areas with greater wind load. Its design allows reducing dynamic loads on the membrane. There are two options for building a floating roof of this design: (1) the roof is equipped with radial compartments and annular compartments of the central part, formed during installation; (2) radial boxes are produced in factory conditions to reduce the volume of installation work.",
          installation:
            "When installing a floating roof, the membrane slope to the center is ensured by loading. This allows draining storm water from the surface of the roof. A flexible or articulated drain is installed in the center, equipped with a intake device and a check valve. This design allows draining water and, at the same time, prevents the stored product in the cylindrical reservoir from appearing on the roof surface.",
          sealing:
            "To seal gaps that occur between the edge of the floating roof and the reservoir wall and between nozzles in the roof and guides, sealing shutters are used. The material from which they are made is selected taking into account the chemical composition and temperature of the product stored in the reservoir, service life requirements, gas tightness and other specific factors.",
        },
      },
      ladders: {
        title: "Ladders for reservoirs, platforms and walkways",
        laddersTitle: "Ladders",
        description:
          "3 types of ladders are used to climb vertical cylindrical reservoirs: stepladders for small volume RVS (up to 500 m³), shaft ladders and ring ladders.",
        shaft:
          "The reservoir shaft ladder is installed on a separate foundation. When manufacturing metal structures by rolling method, the shaft ladder serves as a technological frame (coil) for the reservoir - welded sheets of the wall, bottom and roof deck are wound on it. This provides savings when ordering the entire product, since there is no need to produce a technological frame, which is a non-returnable packaging.",
        ring: "The ring ladder is attached only to the reservoir wall, its lower flight is 250 mm away from the ground. This ladder design is more convenient for servicing technological equipment.",
        specifications:
          "Ladders for vertical steel reservoirs are arranged with a minimum width of 700 mm. The ladder is installed at an angle to the horizontal surface of no more than 50° so that a concentrated load of 4.5 kN is maintained. If the ladder height exceeds 9 m, intermediate platforms are provided in the project at a distance of no more than 6 m from each other.",
        steps:
          "Steps are made of perforated, lattice or corrugated metal with a minimum width of 200 mm, height not more than 250 mm and with a slope from 2° to 5° to the back edge. Ladder handrails are made in such a way that a horizontal load of 0.9 kN is maintained at the top point and are mounted at a height of 1 m.",
        platformsTitle: "Platforms, walkways and fences",
        platforms:
          "On vertical cylindrical reservoirs with stationary roof, fencing is installed along its entire perimeter. Fences are also mounted on the outer side of service platforms located on the roof. The fence is designed so that a load of 0.9 kN is maintained at any point in any direction.",
        platformsAdditional:
          "Walkways and service platforms are also used. They are equipped with railings at a height of 1.25 m. Platforms and walkways withstand a concentrated load of 4.5 kN (on a platform 100 mm x 100 mm).",
      },
    },
  };
  ...
  return (
    <div className="reservoir-types-section">
      ...
      <h3>{currentTranslation.construction.conical.title}</h3>
      <p>{currentTranslation.construction.conical.description}</p>

      <h3>{currentTranslation.construction.spherical.title}</h3>
      <p>{currentTranslation.construction.spherical.description}</p>

      <h3>{currentTranslation.construction.conicalFrame.title}</h3>
      <p>{currentTranslation.construction.conicalFrame.description}</p>
      <p>{currentTranslation.construction.conicalFrame.additional}</p>
      <p>{currentTranslation.construction.conicalFrame.explosion}</p>

      <h3>{currentTranslation.construction.sphericalFrame.title}</h3>
      <p>{currentTranslation.construction.sphericalFrame.description}</p>
      <p>{currentTranslation.construction.sphericalFrame.additional}</p>
      <p>{currentTranslation.construction.sphericalFrame.explosion}</p>

      <h3>{currentTranslation.construction.floating.title}</h3>
      <p>{currentTranslation.construction.floating.description}</p>
      <p>{currentTranslation.construction.floating.types}</p>
      <p>{currentTranslation.construction.floating.single}</p>
      <p>{currentTranslation.construction.floating.singleComponents}</p>
      {currentTranslation.construction.floating.singleList.map(
        (item, index) => (
          <p key={index}>- {item}</p>
        )
      )}
      <p>{currentTranslation.construction.floating.double}</p>
      <p>{currentTranslation.construction.floating.installation}</p>
      <p>{currentTranslation.construction.floating.sealing}</p>

      <h2 className="title">{currentTranslation.ladders.title}</h2>
      <h3>{currentTranslation.ladders.laddersTitle}</h3>
      <p>{currentTranslation.ladders.description}</p>
      <p>
        <b>{currentTranslation.ladders.shaft}</b>
      </p>
      <p>{currentTranslation.ladders.ring}</p>
      <p>
        <b>{currentTranslation.ladders.specifications}</b>
      </p>
      <p>{currentTranslation.ladders.steps}</p>
      <h3>{currentTranslation.ladders.platformsTitle}</h3>
      <p>{currentTranslation.ladders.platforms}</p>
      <p>{currentTranslation.ladders.platformsAdditional}</p>
    </div>
  );
}
