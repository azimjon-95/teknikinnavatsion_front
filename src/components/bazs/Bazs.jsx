...
const AzsStationPage = ({ lang = "ru" }) => {
  const t = {
    ru: {
      ...
      fuelVariants: [
        "3 вида, 6 рукавов, 60м³, цена с НДС: 571.000.000 сум",
        "3 вида, 6 рукавов, 80м³, цена с НДС: 671.000.000 сум",
        "3 вида, 9 рукавов, 60м³, цена с НДС: 699.600.000 сум",
        "4 вида, 8 рукавов, 80м³, цена с НДС: 709.600.000 сум"
      ],
      additional: "Дополнительные возможности:",
      additionalList: [
        "Самообслуживание: Программа «IS» (1 МАЗС) Цена с НДС: +120.000.000 сум",
